...
\begin{reqs}
    ...
    negative.
    \item \textbf{BR-04:} The order state machine allows only the transitions:
    CREATED $\rightarrow$ CONFIRMED/ANNULLED, CONFIRMED $\rightarrow$
    IN\_DELIVERY/ANNULLED, IN\_DELIVERY $\rightarrow$ DELIVERED.
...
\begin{reqs}
    ...
    \item \textbf{NFR-06:} The line coverage of the automated test suite shall
...
FR-02 & UC-01 & FR-06 & UC-05 & FR-10 & UC-09 \\

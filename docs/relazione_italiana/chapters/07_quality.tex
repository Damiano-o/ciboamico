...
\begin{table}[H]
    ...
    \begin{tabular}{@{}llp{9cm}@{}}
        ...
        \texttt{entity} & Entity & \texttt{Ordine}, \texttt{Prodotto}, \texttt{BuonoPromozionale}, \texttt{Ricetta}... \\
...
\begin{itemize}
    ...
    sconti, Observer per le notifiche, Adapter/Facade per i servizi esterni).
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}lll@{}}
        ...
        Strategy (matching) & \texttt{MatchingStrategy} + Strict/Substitution & Comportamentale\\
        ...
        Adapter & \texttt{JakartaMailAdapter}, \texttt{OpenFoodFactsAdapter} & Strutturale\\
        Facade & \texttt{RicettaMatchingFacade} & Strutturale\\
